...
/// LedBalloon's own looks do not have this problem, but presets already on the controller do, and
...
public static class PresetAudit
{
    ...
    /// </para>
    /// </summary>
    public static WledState BuildRefit(LedBalloonProject project, string controllerKey, WledPreset preset)
    {

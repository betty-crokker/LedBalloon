...
public sealed class HouseCanvas : Control
{
    ...
    public static readonly StyledProperty<LedBalloonProject?> ProjectProperty =
        AvaloniaProperty.Register<HouseCanvas, LedBalloonProject?>(nameof(Project));
    ...
    public LedBalloonProject? Project
    {
    ...
    /// </summary>
    private void DrawAimedWash(DrawingContext context, Rect image, LedBalloonProject project, Segment segment)
    {
    ...
    private void DrawEmitters(DrawingContext context, Rect image, LedBalloonProject project, Segment segment)
    {
        RunAppearance appearance = ResolveAppearance(project, segment);
    ...
    private RunAppearance ResolveAppearance(LedBalloonProject project, Segment segment)
    {

...
/// driving a 2D matrix with sound reactivity. Rather than assume, Ledwright reads the device and
...
public sealed class WledCapabilities
{
    ...
    /// <summary>
    /// Whether a Ledwright project is small enough to live on the controller itself. A roomy ESP32

...
public class ProjectFormatTests
{
    ...
    public void A_file_written_with_numeric_fixtures_still_loads()
    {
        ...
        LedBalloonProject? project = Deserialize(Older);
    ...
    public void A_file_from_before_a_field_existed_loads_with_defaults()
    {
        ...
        LedBalloonProject? project = Deserialize(Minimal);
    ...
    public void Unknown_fields_from_a_newer_build_are_ignored_rather_than_fatal()
    {
        ...
        LedBalloonProject? project = Deserialize(Newer);
    ...
    private static string Serialize(LedBalloonProject project) =>
        JsonSerializer.Serialize(
            project,
            (System.Text.Json.Serialization.Metadata.JsonTypeInfo<LedBalloonProject>)
                WledJson.Default.Options.GetTypeInfo(typeof(LedBalloonProject)));

    private static LedBalloonProject? Deserialize(string json) =>
